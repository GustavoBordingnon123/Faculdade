...
def definir_nome_navio_linha(numero_definidor):
    if numero_definidor < 4:
        nome_escolhido = input("jogador 1 por favor, digite a letra da linha que será posicionado o porta aviões: ")
    elif numero_definidor > 3 and numero_definidor < 8:
        nome_escolhido = input("jogador 1 por favor, digite a letra da linha que será posicionado o cruzador: ")
    elif numero_definidor > 7 and numero_definidor < 13:
        nome_escolhido = input("jogador 1 por favor, digite a letra da linha que será possicionado a fragata: ")
...
def colocar_navios():
    ...
    for contador in range(12):
        ...
        if identificador_de_navios < 4:
            while localização_coluna_navios > 16 or localização_coluna_navios < 0:
            ...
            while localização_coluna_navios > 17 or localização_coluna_navios < 0:
                localização_coluna_navios = int(input("espaço insuficiente, digite outra coluna: "))

        elif identificador_de_navios > 8:
            while localização_coluna_navios >= 19 or localização_coluna_navios < 0: 
        ...
        elif identificador_de_navios > 7 and identificador_de_navios < 13:
...
print("ola jogador 1, para posicionar os navios digite primeiro a LETRA da em minusculo da linha que voçe quer, depois o NUMERO da coluna que voçe quer")
print()
...
while jogador_2_jogada_linha != "z" or jogador_2_jogada_coluna != 100:
    ...
    if jogador_2_jogada_coluna == 100:
        break
